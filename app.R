#
# This is a Sentiment Analysis for barclays.
#
...
ui <- fluidPage(theme = shinytheme("darkly"),
                ...
                headerPanel("Barclays Sentiment Analysis"),
                br(),
                ...
                sidebarLayout(
                  ...
                  sidebarPanel(HTML(' <p style="color: #fff; border-color: #2e6da4;font-size: 26px;text-align: center;">
                  
                 Choose Filter Criteria
                <br /> 
                  </p>'),
                               selectInput("platform", "Select Social Media ",
                                           c("Twitter"="tweet")),
                               dateRangeInput("daterange4", "Date range:",
                                              start = Sys.Date()-10,
                                              end = Sys.Date()+10),
                               sliderInput("range", "Age group:",
                                           min = 1, max =110,
                                           value = c(15,45)
                                          ),
                               ...
                               selectInput("variable", "Select Country ",
                                           c("India"="ind",
                                             "UK" = "UK",
                                             "US" = "US")),
                               actionButton("Apply filter", "Apply ",
                  ...
                  mainPanel(
                    ...
                    tabsetPanel(
                      type = "tabs",
                      tabPanel("About Barclays",br(),br(),
                               div(style="display:inline-block;width:32%;text-align: center;",""),
                               br(),br(),plotOutput("classificationPlot"),
                               ),
                      
                      tabPanel("Keyword based report generation",br(),
                               div(style="display:inline-block;width:32%;text-align: center;",""),
                               br(),
                               HTML(' <p style="color: #fff; border-color: #2e6da4;font-size: 26px;text-align: left;">
                              Create New </p>
                              <p>
                              Search for keywords or phrases that yours customers would be talking abouts
                              </p>'),
                               textAreaInput("caption", "", "Enter the word ", width = "700px"),
                               actionButton("Search", "Search",
                                            icon("arrow-circle-right"), 
                                            style="color: #fff; background-color: #033969; border-color: #2e6da4"),),
                      
                      tabPanel("Campaign Comparison",
                               br(),br(),
                               div(style="display:inline-block;width:32%;text-align: center;",""),
                      ...
                      tabPanel("Direct Messages",
                               ...
                               br()),
                      tabPanel("Auto-Comment generation",
                               br(),br(),
                               div(style="display:inline-block;width:32%;text-align: center;",""),
  ...
  output$"classificationPlot" <- renderPlot(
    {
      ...
      pie(slices, labels = lbls, main="SENTIMENT METER",col = c("red", "green","white"))
      legend("topright", c("Positive", "Negative", "Neutral"), 
             cex = 0.8, fill = c("red", "green","white"))
