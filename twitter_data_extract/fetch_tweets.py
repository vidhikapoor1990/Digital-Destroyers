...
api = tweepy.API(auth,wait_on_rate_limit=True,wait_on_rate_limit_notify=True,since=sys.argv[1],
until=sys.argv[2])
...
fName = 'downloadedTweets.txt' # where i save the tweets
